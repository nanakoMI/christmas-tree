...
# 添加圣诞老人和小鹿的卡通图片
st.image("https://upload.wikimedia.org/wikipedia/commons/thumb/a/a3/Santa_Claus_with_gifts.png/800px-Santa_Claus_with_gifts.png", width=150)
st.image("https://upload.wikimedia.org/wikipedia/commons/thumb/e/e8/Rudolph_Reindeer.png/800px-Rudolph_Reindeer.png", width=150)

# 描述
st.write("通过 Streamlit 和 Matplotlib 动态生成一棵漂亮的圣诞树！")
